...
public class ExportNavMeshToObj : MonoBehaviour
{
	...
	static void Export()
	{
        ...
        Directory.CreateDirectory("Assets/data/Navmesh");
		string filename = Application.dataPath + "/data/Navmesh/" + Path.GetFileNameWithoutExtension(EditorApplication.currentScene) + ".obj";
